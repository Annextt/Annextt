...
- [Pokédexl]([https://github.com/Annextt/PopSmoke-FanPage](https://github.com/Annextt/Simple-Pokedex)) - Simple Pokédex project built with HTML, CSS and JavaScript. Uses the PokéAPI to fetch basic Pokémon data such as name, image and type  
